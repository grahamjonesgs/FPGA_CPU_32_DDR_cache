namespace eval ::optrace {
  variable script "/home/graham/Documents/src/fpga/FPGA_CPU_32_DDR_cache/FPGA_CPU_32_DDR_cache.runs/impl_1/mem_read_write.tcl"
...
OPTRACE "add files" START { }
  add_files -quiet /home/graham/Documents/src/fpga/FPGA_CPU_32_DDR_cache/FPGA_CPU_32_DDR_cache.runs/synth_1/mem_read_write.dcp
...
OPTRACE "link_design" START { }
  link_design -top mem_read_write -part xc7a100tcsg324-1 
...
OPTRACE "opt_design reports" START { REPORT }
  ...
  generate_parallel_reports -reports { "report_drc -file mem_read_write_drc_opted.rpt -pb mem_read_write_drc_opted.pb -rpx mem_read_write_drc_opted.rpx"  }
  set_param project.isImplRun false
OPTRACE "opt_design reports" END { }
OPTRACE "Opt Design: write_checkpoint" START { CHECKPOINT }
  write_checkpoint -force mem_read_write_opt.dcp
...
OPTRACE "place_design reports" START { REPORT }
  set_param project.isImplRun true
  generate_parallel_reports -reports { "report_io -file mem_read_write_io_placed.rpt" "report_utilization -file mem_read_write_utilization_placed.rpt -pb mem_read_write_utilization_placed.pb" "report_control_sets -verbose -file mem_read_write_control_sets_placed.rpt"  }
  set_param project.isImplRun false
OPTRACE "place_design reports" END { }
OPTRACE "Place Design: write_checkpoint" START { CHECKPOINT }
  write_checkpoint -force mem_read_write_placed.dcp
...
OPTRACE "Post-Place Phys Opt Design: write_checkpoint" START { CHECKPOINT }
  write_checkpoint -force mem_read_write_physopt.dcp
...
OPTRACE "route_design reports" START { REPORT }
  set_param project.isImplRun true
  generate_parallel_reports -reports { "report_drc -file mem_read_write_drc_routed.rpt -pb mem_read_write_drc_routed.pb -rpx mem_read_write_drc_routed.rpx" "report_methodology -file mem_read_write_methodology_drc_routed.rpt -pb mem_read_write_methodology_drc_routed.pb -rpx mem_read_write_methodology_drc_routed.rpx" "report_power -file mem_read_write_power_routed.rpt -pb mem_read_write_power_summary_routed.pb -rpx mem_read_write_power_routed.rpx" "report_route_status -file mem_read_write_route_status.rpt -pb mem_read_write_route_status.pb" "report_timing_summary -max_paths 10 -report_unconstrained -file mem_read_write_timing_summary_routed.rpt -pb mem_read_write_timing_summary_routed.pb -rpx mem_read_write_timing_summary_routed.rpx" "report_incremental_reuse -file mem_read_write_incremental_reuse_routed.rpt" "report_clock_utilization -file mem_read_write_clock_utilization_routed.rpt" "report_bus_skew -warn_on_violation -file mem_read_write_bus_skew_routed.rpt -pb mem_read_write_bus_skew_routed.pb -rpx mem_read_write_bus_skew_routed.rpx"  }
  set_param project.isImplRun false
OPTRACE "route_design reports" END { }
OPTRACE "Route Design: write_checkpoint" START { CHECKPOINT }
  write_checkpoint -force mem_read_write_routed.dcp
...
OPTRACE "route_design write_checkpoint" END { }
  write_checkpoint -force mem_read_write_routed_error.dcp
...
OPTRACE "phys_opt_design reports" START { REPORT }
  set_param project.isImplRun true
  generate_parallel_reports -reports { "report_timing_summary -max_paths 10 -report_unconstrained -warn_on_violation -file mem_read_write_timing_summary_postroute_physopted.rpt -pb mem_read_write_timing_summary_postroute_physopted.pb -rpx mem_read_write_timing_summary_postroute_physopted.rpx" "report_bus_skew -warn_on_violation -file mem_read_write_bus_skew_postroute_physopted.rpt -pb mem_read_write_bus_skew_postroute_physopted.pb -rpx mem_read_write_bus_skew_postroute_physopted.rpx"  }
  set_param project.isImplRun false
OPTRACE "phys_opt_design reports" END { }
OPTRACE "Post-Route Phys Opt Design: write_checkpoint" START { CHECKPOINT }
  write_checkpoint -force mem_read_write_postroute_physopt.dcp
