...
#
# Script generated by Vivado on Thu Dec 11 10:49:00 SAST 2025
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../ipstatic" +incdir+"../../../../../../../../../../opt/Xilinx/2025.1/data/rsb/busdef" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../ipstatic" +incdir+"../../../../../../../../../../opt/Xilinx/2025.1/data/rsb/busdef" \
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/graham/Documents/src/fpga/FPGA_CPU_32_DDR_cache/FPGA_CPU_32_DDR_cache.cache/compile_simlib/vcs"
  fi
