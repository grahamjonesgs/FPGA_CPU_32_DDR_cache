...
#
# Script generated by Vivado on Wed Jul 05 20:45:33 SAST 2023
...
copy_setup_file()
{
  file="modelsim.ini"
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/graham/Documents/src/FPGA_CPU_32_DDR_cache/FPGA_CPU_32_DDR_cache.cache/compile_simlib/modelsim"
  fi
